...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/data/FaceRecognition/LFW/lfw_align_112', help='The path of lfw data')
    parser.add_argument('--file_list', type=str, default='/data/FaceRecognition/LFW/pairs.txt', help='The path of lfw data')
    parser.add_argument('--backbone_net', type=str, default='MobileFace', help='MobileFace, CBAM_50, CBAM_50_SE, CBAM_100, CBAM_100_SE')
    parser.add_argument('--feature_dim', type=int, default=128, help='feature dimension')
    parser.add_argument('--resume', type=str, default='model/Mobile_MOBILEFACE_20190813_112144/Iter_054000_net.ckpt',help='The path pf save model')
    parser.add_argument('--feature_save_path', type=str, default='result/cur_epoch_lfw_result.mat',help='The path of the extract features save, must be .mat file')
