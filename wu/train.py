...
def train(args):
    ...
    elif args.backbone == 'Res152_IR':
        net = CBAMResNet(152, feature_dim=args.feature_dim, mode='ir')
    elif args.backbone == 'SERes152_IR':
        net = CBAMResNet(152, feature_dim=args.feature_dim, mode='ir_se')
    ...
    for epoch in range(1, args.total_epoch + 1):
        ...
        for data in trainloader:
            ...
            if total_iters % args.test_freq == 0:
                ...
                _print('Current Best Accuracy: LFW: {:.4f} in iters: {}'.format(best_lfw_acc, best_lfw_iters))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='/data/FaceRecognition/WebFace/webface_align_112', help='train image root')
    parser.add_argument('--train_file_list', type=str, default='/data/FaceRecognition/WebFace/align_train.list', help='train list')
    parser.add_argument('--lfw_test_root', type=str, default='/data/FaceRecognition/LFW/lfw_align_112', help='lfw image root')
    parser.add_argument('--lfw_file_list', type=str, default='/data/FaceRecognition/LFW/pairs.txt', help='lfw pair file list')
    ...
    parser.add_argument('--backbone', type=str, default='SERes152_IR', help='MobileFace, Res50_IR, SERes50_IR, Res100_IR, SERes100_IR, Attention_56, Attention_92')
    ...
    parser.add_argument('--model_pre', type=str, default='SERes152_IR_', help='model prefix')
